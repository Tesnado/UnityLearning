...
public class ShopLongPressEvent : MonoBehaviour {
	...
	void Start () {
        ...
        b1 = transform.Find("Shop_Sprite1").GetChild(0).gameObject;
        b2 = transform.Find("Shop_Sprite1").GetChild(1).gameObject;
        b3 = transform.Find("Shop_Sprite1").GetChild(2).gameObject;
        b4 = transform.Find("Shop_Sprite1").GetChild(3).gameObject;
        b5 = transform.Find("Shop_Sprite1").GetChild(4).gameObject;
        b6 = transform.Find("Shop_Sprite1").GetChild(5).gameObject;
        b7 = transform.Find("Shop_Sprite1").GetChild(6).gameObject;
        b8 = transform.Find("Shop_Sprite1").GetChild(7).gameObject;
        b9 = transform.Find("Shop_Sprite1").GetChild(8).gameObject;
